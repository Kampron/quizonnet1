...
var emotion_memoize_esm_default2 = memoize4;
...
var isPropValid = emotion_memoize_esm_default2(
  function(prop) {
...
function useShortcut(props = {}) {
  ...
  const [keys2, setKeys] = (0, import_react66.useState)([]);
...
var useSafeLayoutEffect3 = isBrowser2 ? import_react67.useLayoutEffect : import_react67.useEffect;

// node_modules/@chakra-ui/hooks/dist/chunk-TFWETJDV.mjs
var import_react68 = __toESM(require_react(), 1);
function useCallbackRef2(fn2, deps = []) {
  const ref = (0, import_react68.useRef)(fn2);
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react70.useRef)();
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react75.useRef)();
...
function usePanGesture(ref, props) {
  ...
  const panSession = (0, import_react78.useRef)(null);
  const handlers2 = {
...
function useOptionalPart(partId) {
  const [id, setId] = (0, import_react79.useState)(null);
  const ref = (0, import_react79.useCallback)(
    (node3) => {
...
function useControllableState2(props) {
  ...
  const [valueState, setValue] = (0, import_react80.useState)(defaultValue);
  const isControlled = valueProp !== void 0;
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react80.useCallback)(
    (next2) => {
...
function useDisclosure(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react81.useState)(props.defaultIsOpen || false);
  const [isControlled, isOpen] = useControllableProp(isOpenProp, isOpenState);
  const id = useId3(idProp, "disclosure");
  const onClose = (0, import_react81.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(false);
    }
    onClosePropCallbackRef == null ? void 0 : onClosePropCallbackRef();
  }, [isControlled, onClosePropCallbackRef]);
  const onOpen = (0, import_react81.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(true);
    }
    onOpenPropCallbackRef == null ? void 0 : onOpenPropCallbackRef();
  }, [isControlled, onOpenPropCallbackRef]);
  const onToggle = (0, import_react81.useCallback)(() => {
...
function useEventListenerMap() {
  ...
  const add3 = (0, import_react82.useCallback)((el, type, listener, options) => {
...
var useUpdateEffect2 = (effect5, deps) => {
  const renderCycleRef = (0, import_react83.useRef)(false);
  const effectCycleRef = (0, import_react83.useRef)(false);
...
function useForceUpdate() {
  const unloadingRef = (0, import_react85.useRef)(false);
...
function useAnimationState(props) {
  ...
  const [mounted, setMounted] = (0, import_react86.useState)(isOpen);
  const [once2, setOnce] = (0, import_react86.useState)(false);
...
function useBoolean(initialState2 = false) {
  const [value, setValue] = (0, import_react87.useState)(initialState2);
  const callbacks = (0, import_react87.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(initialValue, optionsOrTimeout = {}) {
  const [hasCopied, setHasCopied] = (0, import_react88.useState)(false);
  const [value, setValue] = (0, import_react88.useState)(initialValue);
  const { timeout = 1500, ...copyOptions } = typeof optionsOrTimeout === "number" ? { timeout: optionsOrTimeout } : optionsOrTimeout;
  const onCopy = (0, import_react88.useCallback)(() => {
...
function useDimensions(ref, observe) {
  const [dimensions, setDimensions] = (0, import_react90.useState)(null);
  const rafId = (0, import_react90.useRef)();
  useSafeLayoutEffect3(() => {
    function measure() {
      const node3 = ref.current;
      if (!node3)
...
var Wrap = forwardRef2(function Wrap2(props, ref) {
  ...
  const styles2 = (0, import_react92.useMemo)(() => {
  ...
  const childrenToRender = (0, import_react92.useMemo)(
    () => shouldWrapChildren ? import_react92.Children.map(children, (child, index) => (0, import_jsx_runtime74.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef2((props, ref) => {
  ...
  const clones = (0, import_react93.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      if (!hasDivider)
        return _child;
      const clonedDivider = (0, import_react93.cloneElement)(
        divider,
        {
          __css: dividerStyle
        }
      ...
      return (0, import_jsx_runtime76.jsxs)(import_react93.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function useHighlight(props) {
  ...
  return (0, import_react94.useMemo)(() => highlightWords({ text, query }), [text, query]);
}
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime83.jsx)(import_jsx_runtime83.Fragment, { children: chunks.map((chunk2, index) => {
    return chunk2.match ? (0, import_jsx_runtime83.jsx)(Mark, { sx: styles2, children: chunk2.text }, index) : (0, import_jsx_runtime83.jsx)(import_react94.Fragment, { children: chunk2.text }, index);
  }) });
}
...
function useMediaQuery(query, options = {}) {
  ...
  const [value, setValue] = (0, import_react96.useState)(() => {
...
function useShortcut2(props = {}) {
  const { timeout = 300, preventDefault = () => true } = props;
  const [keys2, setKeys] = (0, import_react97.useState)([]);
...
function useEventListeners() {
  const listeners = (0, import_react98.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add3 = (0, import_react98.useCallback)((el, type, listener, options) => {
    listeners.current.set(listener, { type, el, options });
    el.addEventListener(type, listener, options);
  }, []);
  const remove = (0, import_react98.useCallback)(
    (el, type, listener, options) => {
...
function useClickable(props = {}) {
  ...
  const [isButton, setIsButton] = (0, import_react99.useState)(true);
  const [isPressed, setIsPressed] = (0, import_react99.useState)(false);
  ...
  const onDocumentKeyUp = (0, import_react99.useCallback)(
    (e) => {
  ...
  const handleKeyUp = (0, import_react99.useCallback)(
    (event) => {
  ...
  const onDocumentMouseUp = (0, import_react99.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      setIsPressed(false);
  ...
  const handleMouseOver = (0, import_react99.useCallback)(
    (event) => {
      if (isDisabled3) {
        event.preventDefault();
        return;
  ...
  const handleMouseLeave = (0, import_react99.useCallback)(
    (event) => {
      if (isPressed) {
        event.preventDefault();
        setIsPressed(false);
...
function useFocusOnShow2(target, options = defaultOptions2) {
  ...
  const autoFocusValue = shouldFocus && visible;
  const autoFocusRef = (0, import_react100.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react100.useRef)(visible);
  useSafeLayoutEffect(() => {
    if (!lastVisibleRef.current && visible) {
      autoFocusRef.current = autoFocusValue;
    }
  ...
  const onFocus3 = (0, import_react100.useCallback)(() => {
    if (!visible || !element || !autoFocusRef.current)
      return;
    autoFocusRef.current = false;
...
function usePopper(props = {}) {
  ...
  const reference2 = (0, import_react101.useRef)(null);
  const popper2 = (0, import_react101.useRef)(null);
  const instance = (0, import_react101.useRef)(null);
  const placement = getPopperPlacement(placementProp, direction2);
  const cleanup = (0, import_react101.useRef)(() => {
  });
  const setupPopper = (0, import_react101.useCallback)(() => {
    var _a8;
  ...
  const referenceRef = (0, import_react101.useCallback)(
    (node3) => {
  ...
  const getReferenceProps = (0, import_react101.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react101.useCallback)(
    (node3) => {
  ...
  const getPopperProps = (0, import_react101.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowProps = (0, import_react101.useCallback)((props2 = {}, ref = null) => {
  ...
  const getArrowInnerProps = (0, import_react101.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useDisclosure2(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react102.useState)(props.defaultIsOpen || false);
  const isOpen = isOpenProp !== void 0 ? isOpenProp : isOpenState;
  const isControlled = isOpenProp !== void 0;
  const uid = (0, import_react102.useId)();
  const id = idProp != null ? idProp : `disclosure-${uid}`;
  const onClose = (0, import_react102.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(false);
    }
    handleClose == null ? void 0 : handleClose();
  }, [isControlled, handleClose]);
  const onOpen = (0, import_react102.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(true);
    }
    handleOpen == null ? void 0 : handleOpen();
  }, [isControlled, handleOpen]);
  const onToggle = (0, import_react102.useCallback)(() => {
    if (isOpen) {
      onClose();
    } else {
      onOpen();
...
function useAnimationState2(props) {
  ...
  const [once2, setOnce] = (0, import_react104.useState)(false);
...
function useMenu(props = {}) {
  ...
  const menuRef = (0, import_react105.useRef)(null);
  const buttonRef = (0, import_react105.useRef)(null);
  const descendants = useMenuDescendants();
  const focusMenu = (0, import_react105.useCallback)(() => {
    requestAnimationFrame(() => {
      var _a8;
      (_a8 = menuRef.current) == null ? void 0 : _a8.focus({ preventScroll: false });
    });
  }, []);
  const focusFirstItem = (0, import_react105.useCallback)(() => {
  ...
  const focusLastItem = (0, import_react105.useCallback)(() => {
    const id2 = setTimeout(() => {
      const last = descendants.lastEnabled();
      if (last)
  ...
  const onOpenInternal = (0, import_react105.useCallback)(() => {
  ...
  const openAndFocusMenu = (0, import_react105.useCallback)(() => {
    onOpen();
    focusMenu();
  }, [onOpen, focusMenu]);
  const timeoutIds = (0, import_react105.useRef)(/* @__PURE__ */ new Set([]));
  useUnmountEffect2(() => {
    timeoutIds.current.forEach((id2) => clearTimeout(id2));
    timeoutIds.current.clear();
  });
  const openAndFocusFirstItem = (0, import_react105.useCallback)(() => {
    onOpen();
    focusFirstItem();
  }, [focusFirstItem, onOpen]);
  const openAndFocusLastItem = (0, import_react105.useCallback)(() => {
    onOpen();
    focusLastItem();
  }, [onOpen, focusLastItem]);
  const refocus = (0, import_react105.useCallback)(() => {
    var _a8, _b5;
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id = `${menuId}-menuitem-${(0, import_react105.useId)()}`;
  const { index, register } = useMenuDescendant({
    disabled: isDisabled3 && !isFocusable3
  });
  const onMouseEnter = (0, import_react105.useCallback)(
    (event) => {
  ...
  const onMouseMove = (0, import_react105.useCallback)(
    (event) => {
  ...
  const onMouseLeave = (0, import_react105.useCallback)(
    (event) => {
  ...
  const onClick = (0, import_react105.useCallback)(
    (event) => {
...
var Menu = (props) => {
  ...
  const context = (0, import_react106.useMemo)(() => ctx, [ctx]);
...
var MenuIcon = (props) => {
  ...
  const child = import_react108.Children.only(children);
  const clone = (0, import_react108.isValidElement)(child) ? (0, import_react108.cloneElement)(child, {
    focusable: "false",
    "aria-hidden": true,
...
var ModalTransition = (0, import_react109.forwardRef)(
  (props, ref) => {
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react110.useState)(0);
...
function useModal(props) {
  ...
  const mouseDownTarget = (0, import_react111.useRef)(null);
  const onMouseDown = (0, import_react111.useCallback)((event) => {
  ...
  const [headerMounted, setHeaderMounted] = (0, import_react111.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react111.useState)(false);
  const getDialogProps = (0, import_react111.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react111.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react111.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  return function wrap3(WrappedComponent) {
    ...
    var SideEffect = function(_PureComponent) {
      ...
      _proto.render = function render() {
        return import_react116.default.createElement(WrappedComponent, this.props);
      };
      return SideEffect2;
    }(import_react116.PureComponent);
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react117.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react117.useCallback)(() => {
    var _a24;
